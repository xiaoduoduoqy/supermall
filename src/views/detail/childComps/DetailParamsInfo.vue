<template>
  <div class="param-info" v-if="Object.keys(itemParams).length!==0">
      <table v-for="(tables,index) in itemParams.rule.tables" class="info-size" :key="index">
    ...
    <div class="info-log" v-if="itemParams.info.images">
      <img :img="itemParams.info.images[0]">
    </div>
  </div>
</template>
